...
namespace SavuDiary.Server.Migrations
{
    ...
    [Migration("20220707054154_AddedTaxTopurchase")]
    partial class AddedTaxTopurchase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SavuDiary.Server.DataLayers.PurchaseDetailEntity", b =>
                {
                    ...
                    b.Property<Guid?>("TaxRecordDetailEntityId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TaxRecordDetailEntityId");
            ...
            modelBuilder.Entity("SavuDiary.Server.DataLayers.PurchaseDetailEntity", b =>
                {
                    b.HasOne("SavuDiary.Server.DataLayers.TaxRecordDetailEntity", "TaxRecordDetailEntity")
                        .WithMany()
                        .HasForeignKey("TaxRecordDetailEntityId");

...
namespace SavuDiary.Server.Migrations
{
    ...
    [Migration("20220716072202_addedfieldsforstocks")]
    partial class addedfieldsforstocks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SavuDiary.Server.DataLayers.TaxRecordDetailEntity", b =>
                {
                    ...
                    b.Property<Guid?>("PurchaseDetailEntityId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PurchaseDetailEntityId");
            ...
            modelBuilder.Entity("SavuDiary.Server.DataLayers.TaxRecordDetailEntity", b =>
                {
                    b.HasOne("SavuDiary.Server.DataLayers.PurchaseDetailEntity", null)
                        .WithMany("TaxRecordDetailEntity")
                        .HasForeignKey("PurchaseDetailEntityId");
                });
            ...
            modelBuilder.Entity("SavuDiary.Server.DataLayers.PurchaseDetailEntity", b =>
                {
                    b.Navigation("TaxRecordDetailEntity");
                });
